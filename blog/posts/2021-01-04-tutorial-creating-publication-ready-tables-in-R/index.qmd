...
{% include figure image_path="images_tables/table1.PNG" %}{: .full}
...
{% include figure image_path="images_tables/table2.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table3.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table4.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table5.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table6.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table7.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
...
{% include figure image_path="images_tables/table8.PNG" %}{: style="max-width: 80%; display: block; margin: 2em auto;"}
