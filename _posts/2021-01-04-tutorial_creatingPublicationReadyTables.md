...
{% include figure image_path="assets/img/images_tables/table2.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table3.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table4.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table5.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table6.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table7.PNG" %}{: .full}
...
{% include figure image_path="assets/img/images_tables/table8.PNG" %}{: .full}
